...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'directory_games', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Here', max_length=140, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'games.name'
        db.delete_column(u'directory_games', 'name')
    ...
    models = {
        ...
        u'directory.games': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Here'", 'max_length': '140', 'null': 'True'}),
            'note': ('django.db.models.fields.CharField', [], {'default': "'default for testing, will be updated later'", 'max_length': '140', 'blank': 'True'}),
            'players_needed': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
